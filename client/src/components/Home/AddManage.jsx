...
class ModalAdd extends Component {
  ...
  render() {
      return (
        <div id="addManageModal" className="modal" tabIndex="-1" role="dialog">
          <div className="modal-dialog" role="document">
            <div className="modal-content">
              ...
              <div className="modal-body">
                <form>
                  <div className="form-group">
                    <label>URL</label>
                    <input autoComplete="off" className="form-control" type="text" name="url" onChange={this.onChange}/>
                  </div>
                  <div className="form-group">
                    <label>Username</label>
                    <input autoComplete="off" className="form-control" type="text" name="username" onChange={this.onChange}/>
                  </div>
                  <div className="form-group">
                    <label>Password</label>
                    <input autoComplete="off" className="form-control" type="text" name="password" onChange={this.onChange}/>
                  </div>
              ...
              <div className="modal-footer">
                <button type="button" onClick={this.submit} className="btn btn-primary" data-dismiss="modal">Save changes</button>
...
export default connect(mapStateToProps, null)(ModalAdd)
